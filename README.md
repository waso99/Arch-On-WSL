...
<br/>
```
sudo pacman -Sy stow sudo base-devel neovim zsh networkmanager zoxide fzf bat trash-cli glibc tcpdump vi git yazi ffmpeg 7zip jq poppler fd ripgrep fzf zoxide resvg imagemagick exa
```
